...
$banner_image_whyus = CFS()->get( 'banner_image_whyus' );
$heading_1 = CFS()->get( 'heading_1' );
$heading_2 = CFS()->get( 'heading_2' );
...
<section class="inner-white wow fadeIn animated" data-wow-duration="1500ms" data-wow-delay="400ms" style="visibility:visible;animation-duration:1500ms;animation-delay:400ms;animation-name:fadeIn">
	<div class="container">
		...
		<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
			<img src="<?php echo $banner_image_whyus; ?>" class="whyusimg" />
			<h3 class="wh3"><?php echo $heading_1; ?></h3>
			<h1 class="whyh1"><?php echo $heading_2; ?></h1>
			<p class="alingcenter"><?php echo $content; ?></p>
		</div>
		<?php
		if($box_section) {
